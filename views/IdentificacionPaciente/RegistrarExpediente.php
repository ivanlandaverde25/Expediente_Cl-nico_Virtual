    ...
    <div class="container">
        <nav class = "navbar">
            ...
            <div class="navbar-menu">
                ...
                <div class = "navbar-brand-main">
                    <a href = "#" id="PaginaPrincipal" class = "navbar-item"> <svg class="navbar-icon" style="width:26px;height:26px" viewBox="0 0 24 24">
                ...
                <div class = "navbar-brand-main" id = "IdentificacionPaciente">
                    <a class = "navbar-item-active" > <svg class=" navbar-icon icon-active" style="width:26px;height:26px" viewBox="0 0 24 24">
                    ...
                    <svg id = "ArrowIdentificacionPaciente" class = "icon-active" style="width:24px;height:24px; transition: .3s ease-in-out;" viewBox="0 0 24 24">
        ...
        <div class="content">
            <header class="main-header">
                <label class = "establecimiento">UNIDAD MEDICA</label>
